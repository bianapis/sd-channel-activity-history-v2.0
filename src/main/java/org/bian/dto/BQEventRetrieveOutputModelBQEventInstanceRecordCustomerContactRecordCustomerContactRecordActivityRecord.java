...
/**
 * BQEventRetrieveOutputModelBQEventInstanceRecordCustomerContactRecordCustomerContactRecordActivityRecord
 */
public class BQEventRetrieveOutputModelBQEventInstanceRecordCustomerContactRecordCustomerContactRecordActivityRecord   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The session dialogue log of actions is returned to SD-Contact Handler and added to the contact record 
